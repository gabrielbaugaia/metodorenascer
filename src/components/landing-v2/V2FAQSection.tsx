...
const faqs = [
  ...
  { q: "O que diferencia do treino online comum?", a: "Treino online prescreve o mesmo protocolo para todos. O GabrielBau prescreve com base nos seus dados daquele dia — VFC, sono, estresse, estado mental. São prescrições completamente diferentes para a mesma pessoa em dias distintos." },
