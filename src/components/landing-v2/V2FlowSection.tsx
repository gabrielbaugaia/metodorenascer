    ...
    <section id="v2-sistema" ref={ref} className="py-[110px] px-7 md:px-[60px] bg-card/50">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-8 relative">
        ...
        {steps.map((s, i) => (
          ...
          >
            <div className="w-[88px] h-[88px] bg-card border border-border flex flex-col items-center justify-center mb-6 relative z-[1] hover:border-foreground transition-colors">
              <div className="absolute inset-[5px] border border-foreground/15" />
              <span className="font-mono-v2 text-[9px] tracking-[1px] text-foreground">{s.n}</span>
