...
export const HeroSection = memo(function HeroSection() {
  return <section className="relative min-h-[100svh] flex items-center justify-center overflow-hidden bg-background pt-24 md:pt-32">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-8">
        ...
        }}>Retome o controle do seu corpo, volte a gostar do que vê no espelho e desenvolva disciplina real, sem pressão e aprendendo a curtir o processo.<span className="text-foreground font-medium animate-pulse">poucos</span> ​
          </p>
