        ...
        <div className="max-w-5xl mx-auto flex flex-col items-center gap-10 md:gap-12">
          ...
          <div className="animate-fade-in w-full flex flex-col items-center gap-6">
            <h1 className="font-display font-black text-foreground text-[3rem] sm:text-6xl md:text-7xl lg:text-8xl leading-[1.05] tracking-[-0.02em] text-center">
              ...
              <span className="block">Busque <span className="text-primary drop-shadow-[0_0_40px_rgba(255,69,0,0.7)]">RENASCIMENTO</span></span>
            </h1>
          </div>

          {/* Subtitle - Single impact phrase */}
          <p 
            className="text-muted-foreground text-xl md:text-2xl max-w-2xl mx-auto animate-fade-in leading-relaxed font-light text-center" 
            style={{ animationDelay: "0.15s" }}
          >
            O método que transforma corpos e reconstrói mentes.
          </p>

          {/* CTA Block - Clean, no price */}
          <div 
