...
export function MethodologySection() {
  ...
  return <section ref={ref} id="metodologia" className={`py-24 section-dark transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-3xl mx-auto text-lg">Para construir o novo, o velho precisa deixar de existir. O Método 
Renascer é uma abordagem integrada focada em alta performance.</p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          {pillars.map((pillar, index) => <Card key={pillar.title} className="bg-primary/10 border-primary/30 animate-fade-in group hover:bg-primary/20 hover:border-primary/50 transition-all duration-300" style={{
