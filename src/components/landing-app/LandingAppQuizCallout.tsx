  ...
  return (
    <section className="py-16 md:py-24 px-7 md:px-[60px] border-y border-border/50 bg-card/30">
      <div className="max-w-[900px] mx-auto text-center">
        <div className="inline-flex items-center font-mono-v2 text-[10px] tracking-[3px] uppercase text-foreground border border-foreground/40 px-[18px] py-[7px] mb-7">
          Não sabe por onde começar?
        </div>
        <h2 className="font-display-v2 text-[clamp(36px,5vw,60px)] leading-[1] tracking-[2px] text-foreground mb-5">
          DESCUBRA SEU PERFIL<br />EM 60 SEGUNDOS<span className="text-foreground">.</span>
        </h2>
        ...
        <Link
          to="/quiz"
          className="font-mono-v2 text-[11px] tracking-[2.5px] uppercase bg-transparent text-foreground px-10 py-4 border border-foreground hover:bg-foreground hover:text-foreground-foreground transition-all duration-200 inline-block"
        >
