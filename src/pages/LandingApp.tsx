...
import { LandingAppHero } from "@/components/landing-app/LandingAppHero";
import { LandingAppQuizCallout } from "@/components/landing-app/LandingAppQuizCallout";

const LandingApp = () => {
  const glowRef = useRef<HTMLDivElement>(null);

  useEffect(() => {
    document.title = "Consultoria Gabriel Baú | App de Prescrição Física, Nutricional e Mental";
    const meta = document.querySelector('meta[name="description"]');
    if (meta) {
      meta.setAttribute(
        "content",
        "App de prescrição física, nutricional e mental que se adapta aos seus dados reais. Treino, nutrição, mindset e SIS Score em um único sistema.",
      );
    }
  }, []);
  ...
  return (
    <div className="min-h-screen bg-background font-body-v2 overflow-x-hidden">
      ...
      <main>
        <LandingAppHero />
        <div
          className="h-[1px] mx-7 md:mx-[60px]"
