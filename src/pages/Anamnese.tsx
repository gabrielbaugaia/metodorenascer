...
export default function Anamnese() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // NOTE: Protocol generation removed from client side
      // Only admins can generate protocols via admin panel
      // Client just saves anamnese data and waits for admin to generate protocols
      
      console.log("[ANAMNESE] Anamnese saved successfully. Protocols will be generated by admin.");
