    ...
    <div className="min-h-screen bg-black text-white">
      <header className="py-6 px-4 border-b border-gray-800">
        <div className="max-w-4xl mx-auto text-center">
          <span className="text-xl font-bold tracking-tight">Gabriel Baú Treinador</span>
        </div>
      </header>
      ...
      <section className="py-16 md:py-24 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8">
            Experimente o Gabriel Baú Treinador sem compromisso. Cancele quando quiser.
          </p>
          <Button
      ...
      <section className="py-16 px-4 border-t border-gray-800">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-gray-300 text-center text-lg">
            ...
            O Gabriel Baú Treinador foi criado para pessoas reais, com rotinas reais, que querem 
