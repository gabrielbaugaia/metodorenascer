    ...
    <div className="min-h-screen bg-black text-white">
      <header className="py-6 px-4 border-b border-gray-800">
        <div className="max-w-4xl mx-auto text-center">
          <span className="text-xl font-bold tracking-tight">Consultoria Gabriel Baú</span>
        </div>
      </header>
      ...
      <section className="py-16 md:py-24 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8">
            Experimente o Consultoria Gabriel Baú sem compromisso. Cancele quando quiser.
          </p>
          <Button
