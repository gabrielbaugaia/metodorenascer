            ...
            <AccordionContent>
              <Card className="border-0 shadow-none">
                <CardContent className="pt-2 space-y-4 text-sm text-muted-foreground">
                  <p>
                    O <strong className="text-foreground">Conector Mobile Gabriel Baú</strong> é um aplicativo nativo (iOS e Android) responsável por sincronizar dados de saúde do dispositivo do usuário com o backend do Gabriel Baú.
                  </p>
  ...
  → Apple Health (HealthKit)
    → Gabriel Baú Connect (app mobile)
      → Edge Function health-sync
        → Banco de Dados
          → Página /dados-corpo no Gabriel Baú`}</CodeBlock>
        ...
        → Banco de Dados
          → Página /dados-corpo no Gabriel Baú`}</CodeBlock>
                  <p className="text-xs text-amber-600 dark:text-amber-400 font-medium">
                    ⚠ O app Gabriel Baú (Lovable/web) NÃO acessa HealthKit diretamente. O conector mobile é obrigatório.
                  </p>
                </CardContent>
              </Card>
            </AccordionContent>
...
<string>O MQO/Gabriel Baú precisa ler seus dados de saúde (passos, calorias e sono) para calcular sua prontidão e personalizar seu treino.</string>
