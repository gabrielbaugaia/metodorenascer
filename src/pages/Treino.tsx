          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              {workouts.length > 0 
                ...
                : "Seu protocolo de treino será gerado em breve"}
            </p>
          </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {protocol.conteudo.descricao || "Fase do seu protocolo"}
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="text-right">
                        ...
                        <div className="w-24 h-1.5 bg-muted rounded-full mt-1 overflow-hidden">
                          <div
                            ...
                            style={{ 
                              width: `${((protocol.conteudo.semana_atual || 1) / protocol.conteudo.total_semanas) * 100}%` 
                            }}
                          />
                        </div>
                      </div>
