...
const LandingPremium = () => {
  ...
  useEffect(() => {
    document.title = "Consultoria Gabriel Baú | Sistema de transformação para adultos +30";
    const meta = document.querySelector('meta[name="description"]');
    if (meta) {
      meta.setAttribute(
        "content",
        "Você não precisa de mais motivação. Você precisa de um sistema. Consultoria Gabriel Baú combina ciência, acompanhamento humano e inteligência de dados.",
      );
    }
  }, []);
