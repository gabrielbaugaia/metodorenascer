  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (authData.user) {
        ...
        toast.success("Conta criada com sucesso! Bem-vindo à Consultoria Gabriel Baú!");
      }
    } catch (error: any) {
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            {referrerName 
              ? `${referrerName} te convidou para fazer parte da Consultoria Gabriel Baú!`
              : "Você foi convidado para fazer parte da Consultoria Gabriel Baú com acesso cortesia!"
            }
          </p>
        </div>
          ...
          <CardContent>
            ...
            <div className="mt-6 p-4 bg-muted/30 rounded-lg border border-border/50">
              <p className="text-xs text-muted-foreground text-center">
                Ao criar sua conta, você terá acesso gratuito por 30 dias a todos os recursos da Consultoria Gabriel Baú, incluindo treinos, nutrição e mentalidade personalizados.
              </p>
            </div>
          </CardContent>
        </Card>
