...
Deno.serve(async (req) => {
  ...
  try {
    // REQUIRE admin JWT or service-role key. This function sends mass
    // emails+push to all users — anonymous calls are rejected.
    ...
    console.error("Error in check-protocol-renewal:", message);
    return new Response(
